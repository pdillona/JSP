			...
			if(isPassOk && confirm('정말 비밀번호를 수정하시겠습니까?')){
				...
				fetch('/Jboard2/myInfo.do', {
					...
					.then((data)=>{
						...
						if(data.result > 0){
							alert('비밀번호가 수정되었습니다. 다시 로그인 하십시요.');
							location.href = '/Jboard2/logout.do';
						}
					});
...
<main id="user">
    <section class="myInfo">
        <form action="/Jboard2/myInfo.do" method="post">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnEmailCode"><img src="/Jboard2/img/chk_auth.gif" alt="인증번호 받기"/></button>
                        <div class="auth">
                            <input type="text" name="auth" placeholder="인증번호 입력"/>
                            <button type="button" id="btnEmailAuth"><img src="/Jboard2/img/chk_confirm.gif" alt="확인"/></button>
                        </div>
                    </td>
                </tr>
                <tr>
