...
<script>
	...
	window.onload = function(){
		...
		btnCheckUid.onclick = function(){
			...
			xhr.open('GET', '/Jboard2/checkUid.do?uid='+inputUid.value);
			xhr.send();
...
<main id="user">
    <section class="register">
        <form action="/Jboard2/register.do" method="post">
            <table border="1">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button"><img src="/Jboard2/img/chk_post.gif" alt="우편번호찾기"/></button>
